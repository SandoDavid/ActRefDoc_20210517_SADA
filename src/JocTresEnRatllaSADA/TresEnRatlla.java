...
public TresEnRatlla() {
      ...
      inicia(); // per inicialitzar el contingut i les variables del taulell de joc
   }
      ...
      public void paintComponent(Graphics g) {  // invocar mitjançant repaint()
         ...
         if (estatActual == EstatDelJoc.EN_JOC) {
            ...
            if (jugadorActual == Cella.CREU) {
               barraDEstat.setText("Torn de les X's");
            } else {
               barraDEstat.setText("Torn de les O's");
            }
